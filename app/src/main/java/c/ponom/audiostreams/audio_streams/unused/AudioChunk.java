...
/**
интересный класс для замены тупых чтений байтовых буферов (если надо сделать их доступными)
 Так же странно что мне не пришло в голову сделать получение в onRead, onWrite и самого буфера
