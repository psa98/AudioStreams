...
class TestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appBarConfiguration = AppBarConfiguration(setOf(R.id.navigation_files,
            R.id.navigation_mic, R.id.navigation_out))
    ...
    private fun isPermissionsGranted(): Boolean {
        val recordPermission = checkSelfPermission(this,
    ...
    override fun onRequestPermissionsResult(requestCode: Int,permissions: Array<out String>,
        ...
        if (grantResults.isEmpty() || grantResults[0] != PERMISSION_GRANTED ||
            ...
            Snackbar.make(binding.root,"Need permissions to work!", Snackbar.LENGTH_LONG).show()
    }
}